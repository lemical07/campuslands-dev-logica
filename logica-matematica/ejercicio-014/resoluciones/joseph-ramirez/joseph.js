const calcularMetricasTatuaje = (participantes, bono, penalizacion) => {
...
console.log(calcularMetricasTatuaje([12, 18, 25, 30], 8, 3));

console.log("\n--- Prueba 2: Caso Borde (Colecciones vacías) ---");
console.log(calcularMetricasTatuaje([], 0, 0));

console.log("\n--- Prueba 3: Caso Propio (Dimensionamiento de Microtatuaje) ---");
console.log(calcularMetricasTatuaje([15, 16, 14, 15], 5, 1)); 