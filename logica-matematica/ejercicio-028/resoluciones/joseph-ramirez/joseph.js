const calcularPatronesPuntuacion = (participantes, bono, penalizacion) => {
...
console.log(calcularPatronesPuntuacion([12, 18, 25, 30], 8, 3));
console.log("\n--- Prueba 2: Caso Borde (Colecciones vacías) ---");
console.log(calcularPatronesPuntuacion([], 0, 0));

console.log("\n--- Prueba 3: Caso Propio (Calificaciones de Estreno de Ópera Espacial) ---");
console.log(calcularPatronesPuntuacion([22, 26, 25, 27], 6, 1)); 