const simularFormulasComida = (participantes, bono, penalizacion) => {
...
console.log(simularFormulasComida([12, 18, 25, 30], 8, 3)); 

console.log("\n--- Prueba 2: Caso Borde (Colecciones vacías) ---");
console.log(simularFormulasComida([], 0, 0));

console.log("\n--- Prueba 3: Caso Propio (Simulación de Eficiencia en Despacho de Pedidos) ---");
console.log(simularFormulasComida([22, 26, 24, 28], 6, 2)); 