...
La solución recibe los datos de la película, aplica reglas de clasificación y devuelve un resultado verificable.
...
```javascript
clasificarPelicula("Proyecto X", -30);
```
