...
// { puntaje_final: 27, porcentaje_liderazgo: 90, porcentaje_participacion_top: 25, clasificacion: 'competitivo', ... }

// prueba caso especial (empate en el maximo, muchos lideres)
console.log(calcularPorcentajeAnalisis([30, 30, 30, 10], 0, 0));
// cantidad_lideres: 3, porcentaje_participacion_top: 75 -> no cumple participacion -> intermedio o principiante

// prueba caso especial (valor negativo, rechazado)
...
console.log(calcularPorcentajeAnalisis([], 5, 5));
