const calcularMetricasTrazo = (participantes, bono, penalizacion) => {
...
console.log(calcularMetricasTrazo([12, 18, 25, 30], 8, 3));

console.log("\n--- Prueba 2: Caso Borde (Colecciones vacías) ---");
console.log(calcularMetricasTrazo([], 0, 0));

console.log("\n--- Prueba 3: Caso Propio (Velocidad de Renderizado en Capas Vectoriales) ---");
console.log(calcularMetricasTrazo([22, 24, 20, 26], 4, 2)); 