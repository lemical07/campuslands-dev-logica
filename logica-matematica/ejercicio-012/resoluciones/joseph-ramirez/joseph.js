const calcularProbabilidadPingPong = (participantes, bono, penalizacion) => {
    if (!participantes?.length || typeof bono !== 'number' || typeof penalizacion !== 'number') {
        return { puntaje_final: 0, clasificacion: "inválido", explicacion: "Error: Parámetros métricos corruptos." };
    }
...
console.log("\n--- Prueba 3: Caso Propio (Probabilidad de Matchpoint Avanzado) ---");
console.log(calcularProbabilidadPingPong([18, 22, 20, 24], 6, 2)); 