const procesarConversionHiperdeportivos = (participantes, bono, penalizacion) => {
    if (!participantes?.length || typeof bono !== 'number' || typeof penalizacion !== 'number') {
        return { puntaje_final: 0, clasificacion: "inválido", explicacion: "Parámetros de conversión corruptos." };
    }
...
console.log(procesarConversionHiperdeportivos([12, 18, 25, 30], 8, 3)); 

console.log("\n--- Prueba 2: Caso Borde (Arreglos vacíos) ---");
console.log(procesarConversionHiperdeportivos([], 0, 0));

console.log("\n--- Prueba 3: Caso Propio (Conversión de Escudería Avanzada) ---");
console.log(procesarConversionHiperdeportivos([20, 22, 24], 5, 2));