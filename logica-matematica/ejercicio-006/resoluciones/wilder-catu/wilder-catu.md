...
Este programa clasifica un automóvil según su velocidad máxima para determinar su categoría dentro de los vehículos de alto rendimiento.

La solución recibe los datos del automóvil, aplica reglas de clasificación y devuelve un resultado verificable.
...
- **Velocidad máxima** en kilómetros por hora (número).
...
```javascript
clasificarAuto("Koenigsegg Jesko", -20);
```
