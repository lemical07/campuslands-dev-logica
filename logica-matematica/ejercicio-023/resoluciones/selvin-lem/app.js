function calcularPromedioMedianaAnalisis(participantes, bono, penalizacion) {
  ...
  return {
    ...
    estabilidad,
    clasificacion,
    explicacion: "se comparo el promedio contra la mediana para medir el sesgo del grupo y su estabilidad; la clasificacion combina el puntaje final frente al promedio y la estabilidad del grupo."
  };
}

// prueba normal (ejemplo)
console.log(calcularPromedioMedianaAnalisis([12, 18, 25, 30], 8, 3));
// { puntaje_final: 27, sesgo: -0.25, estabilidad: 0.99, clasificacion: 'competitivo', ... }

// prueba caso especial (partida muy alta que dispara el sesgo)
console.log(calcularPromedioMedianaAnalisis([5, 6, 7, 100], 0, 0));
// promedio: 29.5, mediana: 6.5, sesgo alto -> estabilidad baja -> principiante o intermedio

// prueba caso borde (un solo elemento)
console.log(calcularPromedioMedianaAnalisis([15], 5, 2));
// { puntaje_final: 18, sesgo: 0, estabilidad: 1, clasificacion: ... }

// prueba caso borde (array vacio)
console.log(calcularPromedioMedianaAnalisis([], 5, 5));
