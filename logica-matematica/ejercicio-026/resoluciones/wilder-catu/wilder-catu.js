...
// Función para clasificar un automóvil según su velocidad máxima.
function clasificarAuto(modeloAuto, velocidadMaxima) {
...
// ======================
const prueba2 = clasificarAuto("Koenigsegg Jesko", -10);
console.log("\nPrueba 2");
console.log(prueba2);