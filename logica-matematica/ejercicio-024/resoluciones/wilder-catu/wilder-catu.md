...
Este programa clasifica el inventario de un modelo de motocicleta según la cantidad de unidades disponibles.
...
```javascript
clasificarInventario("Yamaha FZ 3.0", 15);
```
...
- Clasificación del nivel de inventario.

Si la cantidad disponible es negativa, devuelve un mensaje indicando que el dato es inválido.

### Ejemplo de salida

```javascript
{
    modelo: "Yamaha FZ 3.0",
...
| Cantidad disponible | Clasificación |
|----------------------|---------------|
| 20 o más | Stock alto |
| 10 - 19 | Stock medio |
| 1 - 9 | Stock bajo |
...
```javascript
clasificarInventario("Honda CB190R", -4);
```
