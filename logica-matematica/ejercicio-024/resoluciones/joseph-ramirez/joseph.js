const calcularMetricasMotos = (participantes, bono, penalizacion) => {
    ...
    const promedioBase = sumaTotal / participants.length;
...
console.log(calcularMetricasMotos([12, 18, 25, 30], 8, 3)); 

console.log("\n--- Prueba 2: Caso Borde (Colecciones vacías) ---");
console.log(calcularMetricasMotos([], 0, 0));

console.log("\n--- Prueba 3: Caso Propio (Análisis de Capacidad Máxima de Stock de Repuestos) ---");
console.log(calcularMetricasMotos([21, 27, 23, 25], 7, 2)); 