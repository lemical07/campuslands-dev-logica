# Resolucion - Logica general 053

## Como pensé el problema
El reto plantea un escenario de clasificación de estados basado en jerarquías de riesgo bajo un contexto de paracaidismo, donde ignorar un bloqueo operativo puede comprometer la seguridad. Diseñé la solución centralizando los criterios de control en una única lista inmutable de prioridades, lo cual descarta la necesidad de utilizar estructuras condicionales acopladas difíciles de escalar y mantiene el análisis lineal directo.
